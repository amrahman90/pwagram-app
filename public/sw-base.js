...
workboxSW.router.registerRoute('https://pwagram-c6ce2.firebaseio.com/posts.json', function(args) {
      ...
      readAllData('sync-posts')
        .then(function(data) {
          for (var dt of data) {
            ...
            fetch('https://us-central1-pwagram-c6ce2.cloudfunctions.net/storePostData', {
              method: 'POST',
              body: postData
            })
              .then(function(res) {
